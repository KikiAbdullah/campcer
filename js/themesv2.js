...
var kunciKarya = document.getElementById("kunciKarya");
var lang = document.documentElement.lang;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var kunciKarya = document.getElementById("kunciKarya");
  if (loader && kunciKarya) {
    window.addEventListener("load", function () {
      setTimeout(function () {
        loader.style.display = "none";
        kunciKarya.style.display = "block"; // Gunakan "block" bukan "inherit"
      }, 100);
    });
    ...
    setTimeout(function () {
      if (loader.style.display !== "none") {
        loader.style.display = "none";
        kunciKarya.style.display = "block";
      }
    }, 5000);
  }
});
...
var resizeWorkspace = function resizeWorkspace() {
  ...
  kunciKarya.style.height = "".concat(newHeight, "px");
...
// Detect slide
var slides = document.querySelectorAll(".kuncikarya_slide");
var menus = document.querySelectorAll(".kuncikarya_menu_item");
var kkMenu = document.getElementById("kkMenu");
var menuContainer = document.querySelector(".kuncikarya_menu_list");
var menuWidth = menus.length < 5 ? kkMenu.offsetWidth / menus.length : kkMenu.offsetWidth / 5;
var currentSlide = 0;
...
var jumpSlide = function jumpSlide(index) {
  ...
  var translateX = kkMenu.offsetWidth / 2 - menuWidth / 2 - menus[index].offsetLeft;
